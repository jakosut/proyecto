...
export class DocenteService {
  ...
  public obtenerUsuario(id:string): Observable<docenteDTO> {
    return this.http.get<docenteDTO>(this.apiUrl+'/'+id).pipe(
  ...
  public obtenerTodos(pagina:number, totalRegistrosPorPagina: number): Observable<any> {
    ...
    return this.http.get<docenteDTO[]>(this.apiUrl, {observe:'response',params}).pipe(
      catchError(this.handleError));
  }
